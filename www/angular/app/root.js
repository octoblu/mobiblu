...
angular.module('main')
    .run(function ($rootScope, $timeout, $location, $q, $window, Activity, Plugins, Auth, SkynetRest, Skynet, Config) {
        ...
        $rootScope.openModalSelect = function (title, options, onClick) {
            $rootScope.modalSelect = {};
            $rootScope.modalSelect.title = title;
            $rootScope.modalSelect.options = options;
            $rootScope.modalSelect.onClick = onClick;

            $('#modalSelect').addClass('active');
            setTimeout(function(){
                $('#modalSelect .bar').css('position', 'absolute');
            }, 500);
        };

        $rootScope.closeModalSelect = function () {
            $rootScope.modalSelect = {};
            $('#modalSelect').removeClass('active');
        };
